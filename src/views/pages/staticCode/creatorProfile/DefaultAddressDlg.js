...
import { setDefaultAddress } from "redux/addresses/actions";
import {
  Button,
  Dialog,
  DialogActions,
...
export default function DefaultAddressDlg({ id, open, handleClose }) {
  ...
  const handleDelete = () => {
    dispatch(setDefaultAddress({ id, setLoader, handleClose }));
  };
  return (
    <>
      <Dialog
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description1">
            <Typography variant="body2" component="span" className="statustypo">
              Are you sure you want to make this Address default?
            </Typography>
          </DialogContentText>
        </DialogContent>
