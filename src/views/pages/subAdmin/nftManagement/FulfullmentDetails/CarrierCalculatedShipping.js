...
export const CarrierCalculatedShipping = ({
  theme,
  getCurrency,
  ...
  return (
    <>
      <Stack sx={{ mt: "1rem", width: "75%", flexDirection: "row" }}>
        <Stack mr={"10px"}>
          <Typography sx={{ color: textColor }}>Weight (g)</Typography>
          <TextField
        ...
        <Stack mr={"10px"}>
          <Typography sx={{ color: textColor }}>Length (cm)</Typography>
          <TextField
        ...
        <Stack mr={"10px"}>
          <Typography sx={{ color: textColor }}>Breadth (cm)</Typography>
          <TextField
        ...
        <Stack>
          <Typography sx={{ color: textColor }}>Height (cm)</Typography>
          <TextField
