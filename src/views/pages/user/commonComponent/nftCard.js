...
const NftCard = ({ data }) => {
  ...
  const NftStatus = data?.UserNfts.length !== 0 && data?.UserNfts[0]?.status;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CardImage src={data?.asset} alt={data?.id} />

          <CardContent style={{ padding: "5% 6% 3% 6%" }}>
            <Grid container>
              <Grid item xs={8} sx={{ textAlign: "left", width: "100% !important", maxWidth: "100% !important" }}>
          ...
          title={
            <>
              <span
                ...
                sx={{
                  color: theme.palette.mode === "dark" ? "#000" : "#404040"
                }}
              >
                This item is being resold after being bought, but not yet redeemed by the user.
              </span>
              <span>
                <a
                  href="/privacy-policy"
